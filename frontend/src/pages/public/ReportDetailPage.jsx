  ...
  return (
    <main className="min-h-screen bg-[#0a0b0f] px-4 pb-16 pt-28 text-white">
      <div className="mx-auto max-w-4xl space-y-6">
        ...
        <div className={`rounded-2xl border border-[#2e303a] bg-[#14151d] p-6 ${isDark ? 'bg-[#14151d]' : 'bg-white'}`}>
          ...
          {photoUrl && (
            <div className="mt-6">
              ...
              <a href={photoUrl} target="_blank" rel="noreferrer" className="block overflow-hidden rounded-xl border border-[#2e303a] bg-[#0a0b0f] p-2">
                <img src={photoUrl} alt="Report evidence" className="max-h-80 w-full rounded-lg object-contain" />
              </a>
            </div>
          )}
        </div>
