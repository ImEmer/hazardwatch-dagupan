...
import { HAZARD_CATEGORY_COLORS, PRIORITY_COLORS, REPORT_STATUSES, STATUS_BADGES, STATUS_BADGES_LIGHT } from '../../services/reportOptions';
    ...
    <div className="space-y-6">
      <div className={`flex flex-wrap items-center justify-between gap-3 rounded-2xl border p-4 shadow-xl ${isDark ? 'border-[#2e303a] bg-[#14151d]' : 'border-slate-200 bg-white'}`}>
        ...
        <div className="flex items-center gap-3">
          ...
          <span className={`inline-flex rounded-full border px-2 py-1 text-xs font-medium ${PRIORITY_COLORS[report.priority]?.pill || PRIORITY_COLORS.Medium.pill}`}>
