...
const reports = [
  { id: 'HR-2134', title: 'Blocked drainage channel near Lucao Road', status: 'Monitoring', priority: 'High', date: '2026-09-03' },
  { id: 'HR-2140', title: 'Electrical hazard near residential lane', status: 'Assigned', priority: 'High', date: '2026-09-04' },
  { id: 'HR-2148', title: 'Debris in community access road', status: 'Queued', priority: 'Low', date: '2026-09-05' },
];

const LucaoReportsPage = () => {
  ...
  return (
    <div className="space-y-5">
      <div className="flex items-center justify-between">
        <div>
          <p className={`text-xs uppercase tracking-[0.22em] ${isDark ? 'text-sky-300' : 'text-sky-700'}`}>Lucao</p>
...
export default LucaoReportsPage;
