...
const reports = [
  { id: 'HR-2214', title: 'Waterlogged access road near Tapuac market', status: 'Monitoring', priority: 'High', date: '2026-09-02' },
  { id: 'HR-2221', title: 'Fallen signage near intersection', status: 'Assigned', priority: 'Medium', date: '2026-09-04' },
  { id: 'HR-2230', title: 'Trash overflow in public lane', status: 'Queued', priority: 'Low', date: '2026-09-06' },
];

const TapuacReportsPage = () => {
  ...
  return (
    <div className="space-y-5">
      <div className="flex items-center justify-between">
        <div>
          <p className={`text-xs uppercase tracking-[0.22em] ${isDark ? 'text-sky-300' : 'text-sky-700'}`}>Tapuac</p>
...
export default TapuacReportsPage;
