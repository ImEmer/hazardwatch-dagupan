...
const recentReports = [
  { id: 'HR-2041', title: 'Flooded road near Bonuan market', status: 'Monitoring', priority: 'High' },
  { id: 'HR-2046', title: 'Fallen tree along Rizal Street', status: 'Assigned', priority: 'Medium' },
  { id: 'HR-2052', title: 'Waste blockage near public market', status: 'Queued', priority: 'Low' },
];
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
        <div>
          <p className={`text-xs uppercase tracking-[0.24em] ${isDark ? 'text-sky-300' : 'text-sky-700'}`}>Bonuan</p>
...
export default BonuanDashboard;
