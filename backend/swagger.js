...
const paths = {
  ...
  '/analytics/reports-per-barangay': { get: operation('Get Spark report counts per barangay.', ['Analytics']) },
  '/analytics/reports-per-category': { get: operation('Get Spark report counts per category.', ['Analytics']) },
  '/analytics/reports-per-priority': { get: operation('Get Spark report counts per priority.', ['Analytics']) },
  '/analytics/reports-per-day': { get: operation('Get Spark daily report counts.', ['Analytics']) },
