...
const SubmitReport = () => {
    ...
    const handleMapClick = (location, address) => {
        console.log('📍 LOCATION RECEIVED IN SUBMIT:', location);
        // Include the address inside the selectedLocation object so the map displays it
        setSelectedLocation({ 
            lng: location.lng, 
            lat: location.lat, 
            address: address 
        ...
        <div className="max-w-6xl mx-auto">
            ...
            <div className="lg:col-span-2 bg-[#14151d] border border-[#2e303a] rounded-xl shadow-md p-6">
                ...
                <div>
                    ...
                    <div className="border-2 border-dashed border-[#2e303a] rounded-lg p-4 hover:border-[#3b82f6]/50 transition">
                    {photoPreview ? (
            ...
            <div className="lg:col-span-3">
                <div className="bg-[#14151d] border border-[#2e303a] rounded-xl overflow-hidden h-full">
